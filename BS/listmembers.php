            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <a class="active-menu" href="Listmembers.php"><i class="fa fa-desktop"></i> MEMBER </a>
                    </li>
					<li>
                        <a   href="payment.php"><i class="fa fa-bar-chart-o"></i> PAYMENT </a>
                    </li>
                    <li>
                        <a href="MCR.php.html"><i class="fa fa-qrcode"></i> MCR </a>
                    </li>
    ...
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      ...
      <div class="modal-body" >       	
      	<center> 
        	    ...
        	    <span style="font-size: 15px; font-weight: bold;"><input type="checkbox" name="product" value="LF">&nbsp;La Famillia&nbsp;&nbsp; &nbsp; &nbsp;</span>
        	    <span style="font-size: 15px; font-weight: bold;"><input type="checkbox" name="product" value="M">&nbsp;Maharlika &nbsp; &nbsp;&nbsp;&nbsp;</span>
        		<span style="font-size: 15px; font-weight: bold;"><input type="checkbox" name="product" value="SS">&nbsp;Senor Safira &nbsp; &nbsp; &nbsp;&nbsp;</span>        		
        		</p>
